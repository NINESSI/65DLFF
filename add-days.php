...
<head>
  ...
  <title>Add Days | NewMod Extreme</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Days</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <form action="" method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Days</label>
                    <input type="number" min="1" max="7" name="senha" class="form-control" id="exampleInputPassword1" placeholder="Days" required>
                  </div>
